...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("엔딩 목록") action ShowMenu("endinglist")
...
style main_menu_frame:
    ...
    background "backgrounds/에크모트2.jpg"
...
screen endinglist():
    ...
    use game_menu(_("엔딩 목록"), scroll="viewport"):
        ...
        vbox:
            ...
            label "해금한 엔딩 리스트"
            text _("")
            if (persistent.goodending1 == 1):
                text _("Happy Ending#1 : 백야")
            else:
                text _("Ending#? : ???")
            if (persistent.goodending2 == 1):
                text _("Happy Ending#2 : 망(望)")
            else:
                text _("Ending#? : ???")
            if (persistent.goodending3 == 1):
                text _("Happy Ending#3 : 하늘은 세계의 거울")
            else:
                text _("Ending#? : ???")
            if (persistent.normalending == 1):
                text _("Normal Ending : 새로운 바람")
            else:
                text _("Ending#? : ???")   
            if (persistent.badending1 == 1):
                text _("Bad Ending#1 : 극야")
            else:
                text _("Ending#? : ???")           
            if (persistent.badending2 == 1):
                text _("Bad Ending#2 : 삭(朔)")
            else:
                text _("Ending#? : ???")    
            if (persistent.badending3 == 1):
                text _("Bad Ending#3 : 그리고 아무도 없었다")
            else:
                text _("Ending#? : ???")
            if (persistent.badending4 == 1):
                text _("Bad Ending#4 : 우려가 현실로")
            else:
                text _("Ending#? : ???")        
            if (persistent.badending5 == 1):
                text _("Bad Ending#5 : 휴식은 적당히")
            else:
                text _("Ending#? : ???")
            if (persistent.hiddenending == 1):
                text _("Hidden Ending : Thank You, My God")
            else:
                text _("Ending#? : ???")                    


style test_label is gui_label
style test_label_text is gui_label_text
style test_text is gui_text

style test_label_text:
